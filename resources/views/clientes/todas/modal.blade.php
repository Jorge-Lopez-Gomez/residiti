<div class="container">
    <button type="button" class="btn btn-outline-info mb-8 btn-lg btn-block" data-toggle="modal" data-target="#exampleModal">
        <i class="fa fa-plus-circle"></i> Colaboradores
    </button>
</div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">NOMBRE DEL COLABORADOR:</label>
                    <input type="text" name="nombre" class="form-control" id="recipient-name"  required>
                </div>
                <div class="form-group">
                    <label for="message-text" class="col-form-label">IMAGEN DEL COLABORADOR:</label>
