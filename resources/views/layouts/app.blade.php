...
<head>
    ...
    <title>DITI |Panel administrativo</title>
    <!-- Scripts -->
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('/img/diti.png')}}"  alt="DITI logo" class="brand-image img-circle" style="">
                    <span class="brand-text font-weight-light">DITI</span>
                </a>
