...
<div class="card text-center mx-auto" style="width: 550px;">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <label for="name">Inicio del curso</label>
            <input type="date"  class="form-control" value="{{ date($producto->fech_ini) }}" name="fech_ini">
        </div>
        <div class="form-group col-md-6">
            <label for="extract">Fin del curso</label>
            <input type="date" class="form-control" value="{{ date($producto->fech_fin) }}" name="fech_fin">
        </div>
    </div>
    <div class="card-body">
