...
<div class="mt-3 row-cols-1 card-columns ">
            ...
            <div class="row no-gutters p-2">
                ...
                <div class="col-md-5">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted">Fecha Inicio:{{ $oferta->fech_ini}}</small></p>
                        <p class="card-text"><small class="text-muted">Fecha Fin:{{ $oferta->fech_fin}}</small></p>
    ...
    @endforeach  
        ...
        <div class="alert alert-success" role="alert">
            ...
            <hr>
            <p class="mb-0">Que tengas un hermoso dia Atte: DITI</p>
        </div>
</div>
@endsection