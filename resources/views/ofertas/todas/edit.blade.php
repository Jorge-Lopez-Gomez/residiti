...
<div class="card text-center mx-auto" style="width: 400px;">
    ...
    <div class="card-body">
        ...
        <input type="date" name="fech_ini" class="form-control" value="{{ date($oferta->fech_ini)}}">
    </div>
    <div class="card-body">
        <label for="recipient-name" class="col-form-label">FECHA FIN:</label>
        <input type="date" name="fech_fin" class="form-control" value="{{ date($oferta->fech_fin)}}">
    </div>
